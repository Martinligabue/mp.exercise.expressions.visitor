...
public class ExpressionTypeSystemVisitorTest {
  ...
  public void testConstantType() {
    assertEquals(
      Integer.class,
      new Constant(10).accept(new ExpressionTypeSystemVisitor())
    );
    assertEquals(
      Boolean.class,
      new Constant(true).accept(new ExpressionTypeSystemVisitor())
    );
    assertEquals(
      String.class,
      new Constant("Hello").accept(new ExpressionTypeSystemVisitor())
    );
  }

  @Test
  public void testUnexpectedType() {
    TypeSystemException thrown = assertThrows(
      TypeSystemException.class,
      () -> new Constant(10.1).accept(new ExpressionTypeSystemVisitor())
    );
    assertEquals("Unexpected type Double", thrown.getMessage());
  }
  ...
  public void testEqualIncompatibleTypes() {
    ...
    assertEquals("Incompatible types Integer and String", thrown.getMessage());
  }
  ...
  public void testSumNonIntegerLeftType() {
    ...
    assertEquals("Expected Integer but was String", thrown.getMessage());
  }
  ...
  public void testSumNonIntegerRightType() {
    ...
    assertEquals("Expected Integer but was Boolean", thrown.getMessage());
  }
